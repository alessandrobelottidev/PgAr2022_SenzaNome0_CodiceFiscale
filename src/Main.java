    ...
    public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException {
        ...
        for (int i = 0; i < nList.getLength(); i++) {
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                String comuneNascita = element.getElementsByTagName("comune_nascita").item(0).getTextContent();
                try {
                    Comune comune = new Comune(comuneNascita, Comuni.getInstance().getCodiceComune(comuneNascita));
                    ...
                    System.out.println("Non doveva accadere, evidentemente c'è qualche comune inesistente??");
                    System.exit(0);
                }
            }
        }
